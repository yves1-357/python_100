...
class Question:
    def __init__(self, question_texte, question_answer):
        self.text = question_texte
...
class QuizBrain:
    ...
    def next_question(self):
        ...
        user_reply = str(input(f"Q.{self.question_number + 1 }: {current_question.text} (True/False): "))
